    ...
    override fun onHook() {
        ...
        if (notificationUtilClass != null) {
            ...
            notificationUtilClass.method {
                ...
                before {
                    if (!Prefs.getBoolean(Pref.Key.SystemUI.StatusBar.STATUS_BAR_USE_THE_NATIVE_NOTIFICATION_ICON, false)) return@before
                    result = false
                }
            }
            ...
            if (clazz != null) {
                ...
                clazz.method {}.hookAll {
                    ...
                    after {
                        ...
                        if (!Prefs.getBoolean(Pref.Key.SystemUI.StatusBar.STATUS_BAR_USE_THE_NATIVE_NOTIFICATION_ICON, false)) return@after
