...
object ClipboardNoLimit : YukiBaseHooker() {
    ...
    override fun onHook() {
        ...
        "com.baidu.input.clipboard.manager.BDClipboardManager".toClass().method {
            ...
            before {
                if (!Prefs.getBoolean(Pref.Key.Other.BAIDU_IME_NO_CLIPBOARD_LIMIT, false)) return@before
                result = args[0]
            }
        }
        ...
        // 硬编码上限调大：300 条 / 7000 字。静态字段装上即生效、无法回退，需重启进程跟随开关
        if (Prefs.getBoolean(Pref.Key.Other.BAIDU_IME_NO_CLIPBOARD_LIMIT, false)) {
