...
object AOSPSingleHandModeAdjust : YukiBaseHooker() {
    ...
    override fun onHook() {
        ...
        oHDAOClazz?.method {
            ...
            before {
                if (!aosp_singlehandmode_adjust) return@before
        ...
        oHTHClazz?.method {
            ...
            after {
                if (!aosp_singlehandmode_adjust) return@after
