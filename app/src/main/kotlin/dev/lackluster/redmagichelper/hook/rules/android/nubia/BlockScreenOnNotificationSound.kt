...
object BlockScreenOnNotificationSound : YukiBaseHooker() {
    ...
    override fun onHook() {
        ...
        notificationAttentionHelperClass.method {
            ...
            before {
                if (!Prefs.getBoolean(Pref.Key.Android.DISABLE_SOUND_WHEN_UNLOCKED, false)) return@before
            ...
            after {
                if (!Prefs.getBoolean(Pref.Key.Android.DISABLE_SOUND_WHEN_UNLOCKED, false)) return@after
