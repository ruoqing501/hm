...
object RecordScreenHook : YukiBaseHooker() {
    ...
    override fun onHook() {
        hasEnable(Pref.Key.Other.RERCORD_SCREEN_HIDE_STATUS_BAR) {
            loadApp("com.android.ztescreenshot") {
                ...
                recordClass.method {
                    ...
                    before {
                        ...
                        val context = (instance as? android.view.View)?.context ?: return@before
                        ...
                        when (curState) {
                            ...
                            1 -> { // 录制中 -> 暂停，显示状态栏
                                //YLog.debug(tag = TAG, msg = "即将暂停录制，显示状态栏")
                ...
                // Hook stop 方法，停止录制时显示状态栏-
                //recordClass.method {
                //    name = "stop"
                //    paramCount = 0
                //}.hook {
                //    before {
                //        YLog.debug(tag = TAG, msg = "停止录制，显示状态栏")
                //        val instance = this.instance
                //        val context = (instance as? android.view.View)?.context ?: return@before
                //        sendStatusBarBroadcast(context, true)
                //    }
