...
import dev.lackluster.mihelper.hook.compat.type.android.ContentResolverClass
...
import dev.lackluster.mihelper.hook.compat.type.java.StringType
...
object DisableUSBInstallVerification : YukiBaseHooker() {
    ...
    override fun onHook() {
        hasEnable(Pref.Key.NubiaSystemSettings.DISABLE_USB_INSTALLATION_AND_SWITCH_ACCOUNT_VERIFICATION) {
