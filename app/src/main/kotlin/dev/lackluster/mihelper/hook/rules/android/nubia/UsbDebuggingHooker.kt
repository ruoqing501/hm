...
object UsbDebuggingHooker : YukiBaseHooker() {
    ...
    private val usbDebuggingAutoAllow by lazy {
        Prefs.getBoolean(Pref.Key.NubiaSystemSettings.SYSTEM_SETTINGS_USB_DEBUGGING_AUTO_ALLOW, false)
    }
    ...
    override fun onHook() {
        ...
        // 检测是否已启用
        hasEnable(Pref.Key.NubiaSystemSettings.SYSTEM_SETTINGS_USB_DEBUGGING_AUTO_ALLOW){
