...
package dev.lackluster.mihelper.hook.compat.type.java
...
fun ArrayClass(componentType: Any): Class<*> {
    val component = when (componentType) {
        ...
        is String -> runCatching { dev.lackluster.mihelper.hook.compat.XposedEnv.classLoader.loadClass(componentType) }.getOrNull()
        else -> null
    } ?: Any::class.java
